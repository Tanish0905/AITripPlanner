...
//         { users ?
//           <div className='flex items-center gap-3'>
//             <Button variant='outline' className="rounded-full group-hover:opacity-100 transition-opacity duration-300 text-black bg-gray-200">My Trips</Button> 
//             <Popover>
//               <PopoverTrigger>
//                 <Avatar className="h-[35px] w-[35px]">
//                   <AvatarImage src={users?.picture} alt={users?.name} />
//                   <AvatarFallback>{users?.name?.charAt(0).toUpperCase()}</AvatarFallback>
//                 </Avatar>
//                 {/* <img src={ users?.picture } alt={users?.name?.charAt(0)} className='h-[35px] w-[35px] rounded-full' /> */}
//               </PopoverTrigger>
//               <PopoverContent>
